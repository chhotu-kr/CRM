...
<div class="container mt-5">
    <div class="row">
        ...
        <div class="col-9">
            <h3>Edit Employee here</h3>
            <div class="card">
                <div class="card-body">
                    <form action="{{route('update.employee',$emp)}}" method="POST">
                        @csrf
                        
                        <div class="mb-3">
                            <label for="">First Name</label>
                            <input type="text" name="firstname" class="form-control" value="{{$emp->firstname}}">
                            @error('firstname')
                        ...
                        <div class="mb-3">
                            ...
                            <select name="companies_id" id="" class="form-select" value={{$emp->companies_id}}>
